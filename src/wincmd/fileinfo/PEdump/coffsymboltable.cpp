...
{
	if ( !m_pSymbolData ) return 0;
	sprintf( m_szTypeName, "%04Xh", m_pSymbolData->Type );
...
PCOFFSymbol COFFSymbolTable::GetNearestSymbolFromRVA( ULONGLONG rva, BOOL fExact )
{
	if ( !fExact ) return 0;
